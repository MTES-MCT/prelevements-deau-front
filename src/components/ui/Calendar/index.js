...
const CalendarCell = ({cellInfo, cellSize, renderTooltipContent, onClick}) => {
  ...
  let classes = 'rounded flex items-center justify-center text-xs sm:text-sm font-medium text-center transition-colors duration-150 ease-in-out relative overflow-hidden'
  ...
  // Ajout de l'effet d'assombrissement au survol
