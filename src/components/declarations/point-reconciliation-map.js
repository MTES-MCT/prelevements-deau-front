...
const PointReconciliationMap = ({
  ...
  if (pointsWithCoordinates.length === 0) {
    return (
      <div className='flex h-[min(56vh,520px)] min-h-[320px] items-center justify-center border border-dashed border-gray-300 bg-white p-4 text-center'>
  ...
  return (
    <div className='relative h-[min(56vh,520px)] min-h-[340px] w-full overflow-hidden border border-gray-300 bg-white'>
      {hasMapMoved && (
        <button
          type='button'
