...
export async function getPointsPrelevement() {
  const response = await executeRequest({url: 'api/points-prelevement'})
  return response.json()
}

export async function getPointPrelevement(id) {
  const response = await executeRequest({url: `api/points-prelevement/${id}`})
  return response.json()
}
...
export async function deletePointPrelevement(id) {
  const response = await executeRequest({url: `api/points-prelevement/${id}`, method: 'DELETE'})
  return response.json()
}

export async function getPreleveur(id) {
  try {
    const response = await executeRequest({url: `api/preleveurs/${id}`})
    return response.json()
  } catch {
    return null
  }
...
export async function getPreleveurs() {
  try {
    const response = await executeRequest({url: 'api/preleveurs'})
    return response.json()
  } catch {
    return null
  }
...
export async function getPointsFromPreleveur(idPreleveur) {
  try {
    const response = await executeRequest({url: `api/preleveurs/${idPreleveur}/points-prelevement`})
    return response.json()
  } catch {
    return null
  }
...
export async function updateExploitation(idExploitation, payload) {
  const response = await executeRequest({
    url: `api/exploitations/${idExploitation}`,
    method: 'PUT',
    body: JSON.stringify(payload)
  })
...
export async function getExploitation(exploitationId) {
  const response = await executeRequest({url: `api/exploitations/${exploitationId}`})
...
export async function getExploitationsByPointId(pointId) {
  const response = await executeRequest({url: `api/points-prelevement/${pointId}/exploitations`})
...
export async function deleteExploitation(exploitationId) {
  const response = await executeRequest({
    url: `api/exploitations/${exploitationId}`,
    method: 'DELETE'
  })
...
export async function getStats() {
  const response = await executeRequest({url: 'api/stats'})
...
export async function getVolumesExploitation(exploitationId) {
  const response = await executeRequest({url: `api/exploitations/${exploitationId}/volumes-preleves`})
  const volumes = await response.json()
  return volumes
}

export async function getBnpe() {
  const response = await executeRequest({url: 'api/referentiels/bnpe'})
...
export async function getMeso() {
  const response = await executeRequest({url: 'api/referentiels/meso'})
...
export async function getMeContinentales() {
  const response = await executeRequest({url: 'api/referentiels/me-continentales-bv'})
...
export async function getBvBdcarthage() {
  const response = await executeRequest({url: 'api/referentiels/bv-bdcarthage'})
