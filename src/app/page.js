    ...
    <>
      ...
      >
        <Box className='flex flex-col gap-10'>
          ...
          <Typography variant='body1'>
            Depuis 2024, ces dernières sont transmises mensuellement par les préleveurs via un formulaire en ligne (<a href='https://demarche.numerique.gouv.fr/commencer/suivi-prelevements-eau-974'>https://demarche.numerique.gouv.fr/commencer/suivi-prelevements-eau-974)</a>. A ce jour, tous les prélèvements sont concernés sauf ceux soumis au régime des installations classées pour la protection de l’environnement (ICPE) ou des concessions hydroélectriques.
          </Typography>
          <Typography variant='body1'>
